...
def construct_preselection(preselection: PreselectionModel) -> Preselection:
    return Preselection(
        id=preselection.id,
...
class PreselectionFeature:
    ...
    async def get_preselections(self) -> list[Preselection]:
        try:
            ...
            for preselection in preselections:
                result.append(construct_preselection(preselection))
            return result
    ...
    async def get_preselection_by_name(self, preselection_name: str) -> Preselection | None:
        try:
            ...
            return construct_preselection(preselection)
