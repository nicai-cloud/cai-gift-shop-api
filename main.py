...
from infrastructure.custom_bag_items_repo import CustomBagItemsRepo, construct_postgres_custom_bag_items_repo
from infrastructure.custom_bag_order_item_repo import CustomBagOrderItemRepo, construct_postgres_custom_bag_order_item_repo
...
def create_api():
    ...
    work_manager.register(CustomBagItemsRepo, construct_postgres_custom_bag_items_repo)
    work_manager.register(CustomBagOrderItemRepo, construct_postgres_custom_bag_order_item_repo)
